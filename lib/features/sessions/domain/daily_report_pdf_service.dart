          ...
          children: [
            pw.Text(
              ...
              style: pw.TextStyle(
                ...
                fontSize: 22,
                color: PdfColor.fromInt(0xFF1E3A8A), // GrillPOS Primary Blue
              ),
            ),
            pw.SizedBox(height: 6),
            pw.Text(
              'نظام نقاط البيع المتطور - GrillPOS',
              style: pw.TextStyle(
                font: boldFont,
                fontSize: 13,
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.TableHelper.fromTextArray(
          ...
          headerDecoration: pw.BoxDecoration(color: PdfAppColors.mutedColor200),
  ...
  static pw.Widget _buildFooter(pw.Font font) {
    return pw.Container(
      ...
      child: pw.Column(children: [
        ...
        pw.SizedBox(height: 3),
        pw.Text(
          '© 2026 GrillPOS POS - جميع الحقوق محفوظة',
          style: pw.TextStyle(font: font, fontSize: 10, color: PdfAppColors.mutedColor700),
        ),
      ]),
    );
